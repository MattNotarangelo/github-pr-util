...
| [DMR-715: Deploy kafka-configs in ap-northeast-1 and eu-central-1](https://github.com/ROKT/kafka-configs/pull/719) | Feat: Kafka data residency changes                                                                                                                                 |
...
| [NO-JIRA: Refactor mm2 helm config](https://github.com/ROKT/kafka/pull/222)                      | Improvement: Reduced size and complexity of MM2 helm values by using standardised config                                                                               |
...
## ROKT/kafka-autoscaler

| Pull request | Impact |
| ------------ | ------ |

## ROKT/rokt-kubeflow-resources

| Pull request | Impact |
| ------------ | ------ |

## ROKT/rokt-kubeflow-sdk-v2
...
| [NO-JIRA: use SANITISED_BRANCH_NAME for escaping / in branch names](https://github.com/ROKT/aws-eks/pull/1177) | Fix: fix bug in aws-eks script          |
